...
import com.example.projetoandroid.ViewModel.InicioActivity
import com.example.projetoandroid.databinding.CityViewholderBinding
import com.example.projetoandroid.model.CityResponseApi
...
class CityAdapter: RecyclerView.Adapter<CityAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CityAdapter.ViewHolder, position: Int) {
        ...
        binding.root.setOnClickListener{
            val intent=Intent(binding.root.context,InicioActivity::class.java)
